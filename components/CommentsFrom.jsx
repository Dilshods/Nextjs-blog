  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
      ...
      <div className='grid grid-cols-1 gap-4 pb-4'>
        <textarea 
          ref={commentEl}
          className="p-4 outline-none w-full rounded-lg focus:ring-2 focus:gray-200 bg-gray-100 text-700"
      ...
      <div className='grid grid-cols-1 gap-4 pb-4'>
        <div>
          ...
          <label htmlFor='storeData' className='text-gray-500 cursor-pointer ml-2'>Save my name, email in this browser for the next time l comment</label>
        </div>
      </div>
